...
export default function App(params) {
  ...
  const handleClick = async (componentKey,checkToken) => {
    ...
    if(authToken==null){
      ...
      try {
        const response = await fetch(`https://voitureoccasion-production.up.railway.appUtilisateurs/isTokenValide`, {
          method: 'GET',
          headers: {
  ...
  const deconnection = async (componentKey) => {
    ...
    try {
      const response = await fetch(`https://voitureoccasion-production.up.railway.appUtilisateurs/deconnection`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${authToken}`,
                    ...
                    <li className="menu-title">Statistique</li>
                      <li className="menu-item-has-children dropdown">
                          ...
                          <ul className="sub-menu children dropdown-menu">
                              <li><i className="menu-icon fa fa-th"></i><a href="#" onClick={() => handleClick('formulaireStatVoitureDefinie',true)}>Voiture les plus vendues</a></li>
                              <li><i className="menu-icon fa fa-th"></i><a href="#" onClick={() => handleClick('formulaireRevenueUtilisateur',true)}>Rang revenue par utilisateur</a></li>
