...
const FormulaireStatVenteUtilisateur = ({ onFormSubmit }) => {
  ...
  const [date, setDate] = useState({ dateDebut: '2024-01-09', dateFin: '2024-01-09' });
                    ...
                    <div id="pay-invoice">
                        <div className="card-body">
                            <div className="card-title">
                                <h3 className="text-center">Statistique rang utilisateur qui ont vendu plus de voiture</h3>
                            </div>
                            <hr/>
                            ...
                            {formSubmitted && <StatistiqueVenteUtilisateur key={key} date={date} />}
                        </div>
                    </div>
...
export default FormulaireStatVenteUtilisateur;
